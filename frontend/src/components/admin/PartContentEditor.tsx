...
const BLOCK_KINDS: Record<string, string> = {
  ...
  bullet: "مورد فهرست",
  row: "ردیف تابلو (طبقه/برچسب + متن) — مثل راهنمای فروشگاه",
  picture: "تصویر حرف‌دار (برچسب a تا i + عکس) — گالری شنیداری",
};
...
const RECIPES: Record<string, string> = {
  ...
  mcq: "اگر متن خواندنی دارد در بلوک‌ها بنویس. گزینه‌ها را می‌توانی برای هر سؤال جدا بگذاری یا از «گزینه‌های مشترک» استفاده کنی. تابلوی راهنمای فروشگاه = بلوک‌های «ردیف تابلو» (برچسب = طبقه). تصاویر حرف‌دار شنیداری = بلوک‌های «تصویر حرف‌دار» با برچسب a تا i و همان حرف‌ها در «گزینه‌های مشترک».",
  listening_mixed:
